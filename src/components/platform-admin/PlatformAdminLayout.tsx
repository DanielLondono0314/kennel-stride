...
import { LayoutDashboard, Building2, Users, Activity, ServerCog, ShieldCheck, LogOut } from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { to: "/platform-admin/usage", label: "Uso y consumo", icon: Activity, end: false },
  { to: "/platform-admin/infra", label: "Infraestructura", icon: ServerCog, end: false },
